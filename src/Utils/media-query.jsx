...
const horizontalMedia = window.matchMedia('(orientation: landscape)'); // Check for horizontal orientation

const mediaQueries = [xSmallMedia, smallMedia, mediumMedia, largeMedia, horizontalMedia];
...
function getScreenSize() {
  return {
    XS: xSmallMedia.matches,
    isSmall: smallMedia.matches,
    isMedium: mediumMedia.matches,
    Lg: largeMedia.matches,
    Hz: horizontalMedia.matches
  };
}
