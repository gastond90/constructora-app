...
function Nosotros() {
return ( 
<div id="Sobre Nosotros" className='flex justify-center px-32' style={{width:"auto",maxHeight:"100vh",height:"100vh", overflowY:'auto',backgroundImage: `url(${fondonos})`, backgroundSize:"cover"}}>
        <div className='flex flex-col items-start justify-start my-2 pt-8 sm:pt-20 ml-8 w-2/5'>
            <p className='tituloSobre'>SOBRE</p>
            <p className='tituloSobreBold'>NOSOTROS</p>
            <img src={flecha} alt="" className="w-10 mt-16 mb-4"/>
        </div>
      
            <div className='flex flex-col justify-end pb-16 pr-16 mr-0 sm:pr-0 w-3/5 items-center'>
