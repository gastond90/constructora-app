...
return (
    <div id="footer" className='bg-rojo-100 ' style={{width:"auto",height:"25vh"}} >
        <div className='w-full h-full flex items-center flex-col sm:flex-row justify-center sm:px-16 lg:px-16'>
            ...
            <div className='flex items-center sm:w-3/5 sm:justify-center'>
            ...
            <div className='flex h-1/3 sm:w-1/5 sm:justify-center items-center flex-row'>
                ...
                <Insta/>
                <Linkedin/>
                <div className='flex sm:hidden ml-2' onClick={sendWhatsAppMessage}>
