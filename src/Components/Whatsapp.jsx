...
export default function Whatsapp() {
  ...
  return ( 
  <div className='flex w-full lg:w-11/12 sm:w-11/12 justify-end pr-4 sm:pr-0 lg:pr-0 cursor-pointer' title='Escribinos' style={{ position: 'fixed', bottom: 25, /* width: '100%', */ zIndex: 1000 }} onClick={sendWhatsAppMessage}>
